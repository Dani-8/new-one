...
export default function App() {
  ...
  return (
    <div className={`min-h-screen relative font-sans flex flex-col transition-colors duration-500 ${
        ...
        {isAdminView ? (
          ...
          >
            <div className={`p-4 rounded-2xl border flex flex-col sm:flex-row sm:items-center justify-between gap-4 ${
              isDarkMode ? 'bg-[#1b162c]/60 border-purple-500/20' : 'bg-purple-50 border-purple-100'
            }`}>
                ...
                <>
                  ...
                  >
                    ...
                    <div className="relative z-10 px-6 sm:px-12 py-16 sm:py-24 max-w-xl text-white space-y-6">
                      ...
                      <p className="text-sm sm:text-base text-gray-300 leading-relaxed font-light">
                        Welcome back to Golden Bite, where luxury recipes meet magical warm aesthetics. Select your customizable ingredients and track live, freshly prepared bites straight to your door.
                      </p>
                  ...
                  <motion.section
                    ...
                    className={`p-6 sm:p-8 rounded-3xl border ${
                      isDarkMode ? 'bg-zinc-900/30 border-white/[0.04] shadow-md' : 'bg-slate-50/50 border-slate-100 shadow-sm'
                    }`}
                  >
                    <MealBuilder
                      foods={foods}
        ...
        <AnimatePresence>
          {toasts.map((t) => (
            <motion.div
              ...
              className={`p-4 rounded-xl shadow-lg border backdrop-blur-md pointer-events-auto flex items-center space-x-3 transition-all duration-300 ${
                t.type === 'success'
      ...
      <footer className={`py-12 border-t mt-12 transition-colors duration-300 ${
        isDarkMode ? 'bg-[#06040c] border-zinc-900 text-gray-500' : 'bg-amber-50/20 border-slate-100 text-gray-600'
      }`}>
