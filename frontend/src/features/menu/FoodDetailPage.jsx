    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between">
                <button
                    onClick={onBack}
                    className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold uppercase tracking-wider cursor-pointer transition-all border ${isDarkMode
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-7 space-y-6">
                    <div className={`overflow-hidden rounded-3xl border ${isDarkMode ? 'bg-zinc-900/40 border-white/[0.04]' : 'bg-white border-slate-100 shadow-xl'
                        }`}>
                        <div className="relative h-64 sm:h-96 w-full overflow-hidden bg-black/5">
                            ...
                            <div className="absolute top-5 right-5 flex items-center gap-2">
                                ...
                                >
                                    <Heart className={`h-4 w-4 transition-colors duration-200 ${isFavorite ? 'fill-amber-500 text-amber-500' : 'text-white group-hover:text-amber-400'
                                        }`} />
                                </button>
                            </div>
                        ...
                        <div className="p-6 sm:p-8 space-y-4">
                            <div>
                                ...
                                <h1 className={`font-sans text-2xl sm:text-3xl font-extrabold tracking-tight mt-1 leading-tight ${isDarkMode ? 'text-white' : 'text-gray-950'
                                    }`}>
                                    {food.name}
                                </h1>
                            </div>
                            ...
                            <div className="pt-4 flex flex-wrap gap-2">
                                {food.tags.map((tag) => (
                                    <span
                                        key={tag}
                                        className={`text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-md ${isDarkMode
                    ...
                    {/* Freshness Promise */}
                    <div className={`p-5 rounded-2xl border flex gap-4 items-start ${isDarkMode ? 'bg-zinc-900/30 border-white/[0.04]' : 'bg-slate-50/50 border-slate-100'
                        }`}>
                ...
                <div className="lg:col-span-5 space-y-6">
                    <div className={`rounded-3xl border p-6 sm:p-8 space-y-6 relative overflow-hidden ${isDarkMode ? 'bg-zinc-900/40 border-white/[0.04] text-white shadow-lg' : 'bg-white border-slate-100 text-gray-800 shadow-xl'
                        }`}>
                        ...
                        <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-4 gap-1.5">
                                        {['Mild', 'Medium', 'Hot', 'Extra Hot'].map((level) => (
                                            <button
                                                ...
                                                className={`py-2 rounded-xl text-[11px] font-extrabold border transition-all cursor-pointer ${detail.spiceLevel === level
                            ...
                            {food.category !== 'Drinks' && food.category !== 'Desserts' && (
                                <div className="space-y-2.5">
                                    ...
                                    <div className="space-y-2">
                                        <label className={`flex items-center justify-between p-3 rounded-xl border cursor-pointer transition-all duration-200 ${detail.extraCheese ? 'border-amber-500 bg-amber-500/5 shadow-sm' : isDarkMode ? 'border-white/5 hover:border-white/10 hover:bg-white/5' : 'border-gray-100 hover:bg-gray-50'
                                            }`}>
                                        ...
                                        <label className={`flex items-center justify-between p-3 rounded-xl border cursor-pointer transition-all duration-200 ${detail.extraSauce ? 'border-amber-500 bg-amber-500/5 shadow-sm' : isDarkMode ? 'border-white/5 hover:border-white/10 hover:bg-white/5' : 'border-gray-100 hover:bg-gray-50'
                                            }`}>
                                            <div className="flex items-center gap-2.5">
                                        ...
                                        <label className={`flex items-center justify-between p-3 rounded-xl border cursor-pointer transition-all duration-200 ${detail.glutenFree ? 'border-amber-500 bg-amber-500/5 shadow-sm' : isDarkMode ? 'border-white/5 hover:border-white/10 hover:bg-white/5' : 'border-gray-100 hover:bg-gray-50'
                                            }`}>
                                            <div className="flex items-center gap-2.5">
